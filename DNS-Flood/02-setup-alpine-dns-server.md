...
위 구조를 통해 DNS Query Flooding, DNS Reflection Attack를 바로 실습하지 않습니다. 각 실습에서는 상황에 맞게 구조를 추가할 것이며 이를 위한 기본 세팅입니다.   

> (DNS Resolver, Root/TLD/Auth 서버가 나뉘어져있지 않은 이유이기도 합니다. 다음 실습에서 추가할 예정입니다.)
...
- 다운로드 버전 : Alpine Extended Version 3.23.2 (Released Dec 17, 2025)
